...
WINAPI
ExtExtension::ExtExtension(void) noexcept
                               ...
                               _In_ ULONG TimeoutMilliseconds)
{
    ...
    GetExprU64("@$callret", static_cast<UINT64>(-1), &RetVal);
    return RetVal;
}
...
{
    HRESULT Status  = S_OK;
    auto DataHolder = ExtDeclAlignedBuffer<BYTE, sizeof(EXT_TYPED_DATA) + 10 * sizeof(ULONG64)>();

    EXT_TYPED_DATA* ExtData = nullptr;
    ULONG ExtDataBytes = 0;
    PBYTE ExtraData = nullptr;
