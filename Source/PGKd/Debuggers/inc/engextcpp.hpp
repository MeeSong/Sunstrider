...
{
public:
    ExtInterruptException(void) noexcept
...
{
public:
    ExtCurrentThreadHolder(void) noexcept
    {
...
{
public:
    ExtCurrentProcessHolder(void) noexcept
    {
...
{
public:
    ExtEffectiveProcessorTypeHolder(void) noexcept
    {
...
public:
    ...
    void Set(_At_(Ptr, __drv_aliasesMem) _In_reads_(Elts) _T* Ptr,
             _In_ ULONG Elts,
             _In_ bool Owned,
             _In_ ULONG Used)
    {
...
{
public:
    ExtDeclAlignedBuffer(void) noexcept :
        ExtBuffer<_T>((_T*)m_Decl, _DeclElts, false, 0)
    {
    };
...
public:
    ...
    ExtExtension* m_Ext     = nullptr;
    ExtCommandDesc* m_Next  = nullptr;
    PCSTR m_Name            = nullptr;
    ExtCommandMethod m_Method = nullptr;
    PCSTR m_Desc            = nullptr;
    PCSTR m_ArgDescStr      = nullptr;
    bool m_ArgsInitialized  = false;
    ...
    bool m_CustomArgParsing = false;
    PSTR m_CustomArgDescShort = nullptr;
    PSTR m_CustomArgDescLong = nullptr;
    PSTR m_OptionChars = nullptr;
    PSTR m_ArgStrings = nullptr;
    ULONG m_NumArgs = 0;
    ULONG m_NumUnnamedArgs = 0;
    ArgDesc* m_Args = nullptr;
...
{
public:
    WINAPI ExtExtension(void) noexcept;
    ...
    USHORT m_ExtMajorVersion = 1;
    USHORT m_ExtMinorVersion = 0;
    ULONG m_ExtInitFlags     = DEBUG_EXTINIT_HAS_COMMAND_HELP;

    ExtKnownStruct* m_KnownStructs = nullptr;
    ExtProvidedValue* m_ProvidedValues = nullptr;
    ...
    ULONG m_Machine = 0;
    ULONG m_PageSize = 0x1000;
    ULONG m_PtrSize = sizeof(void*);
    ULONG m_NumProcessors = 0;
    ULONG64 m_OffsetMask = 0;
    ...
    ULONG m_DebuggeeClass = 0;
    ULONG m_DebuggeeQual  = 0;
    ULONG m_DumpFormatFlags = 0;

    bool m_IsRemote = false;
    bool m_OutCallbacksDmlAware = false;
    ...
    ULONG m_OutMask = DEBUG_OUTPUT_NORMAL;
    ...
    ULONG m_CurChar = 0;
    ULONG m_LeftIndent = 0;
    bool m_AllowWrap = true;
    bool m_TestWrap = false;
    ULONG m_TestWrapChars = 0;
    ...
    PSTR m_AppendBuffer = nullptr;
    ULONG m_AppendBufferChars = 0;
    PSTR m_AppendAt = nullptr;
    ...
    ExtCommandDesc* m_Commands = nullptr;
    ULONG m_LongestCommandName = 0;
    HRESULT m_CallStatus = S_OK;
    HRESULT m_MacroStatus= S_OK;

    typedef BOOL (WINAPI *PFN_SymMatchStringA)(_In_ PCSTR string,
                                               _In_ PCSTR expression,
                                               _In_ BOOL fCase);
    HMODULE m_DbgHelp = nullptr;
    PFN_SymMatchStringA m_SymMatchStringA = nullptr;
    ...
    ExtCommandDesc* m_CurCommand = nullptr;
    PCSTR m_RawArgStr = nullptr;
    PSTR m_ArgCopy = nullptr;
    ULONG m_NumArgs = 0;
    ULONG m_NumNamedArgs = 0;
    ULONG m_NumUnnamedArgs = 0;
    ULONG m_FirstNamedArg = 0;
    // Unnamed args are packed in the front.
    ArgVal m_Args[s_MaxArgs]{};

    // Register index caches are cleared in QueryMachineInfo.
    ULONG m_ExtRetIndex = 0;
    ULONG m_TempRegIndex[20]{};
    
    bool m_ExInitialized = false;
...
public:
    ...
    PCSTR   m_Name          = nullptr;
    ULONG64 m_Offset        = 0;
    bool    m_ValidOffset   = false;
    ULONG   m_Bytes         = 0;
    ULONG64 m_Data          = 0;
    bool    m_ValidData     = false;
    bool    m_Physical      = false;
    ULONG   m_SpaceFlags    = 0;
...
public:
    ...
    PCSTR   m_Type          = nullptr;
    ULONG64 m_TypeModBase   = 0;
    ULONG   m_TypeId        = 0;
};
...
{
public:
    ExtCaptureOutput(void) noexcept
    {
        m_Started = false;
        m_Text = NULL;
    ...
    ULONG m_AllocChars = 0;
    ULONG m_UsedChars = 0;
    ULONG m_CharTypeSize = 0;
    _CharType* m_Text = nullptr;

    _BaseClass* m_OldOutCb = nullptr;
};
